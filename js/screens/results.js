/* ============================================
   VELOCITY — RESULTS SCREEN (DEFINITIVE)
                        ...
                        <table class="results-table">
                            ...
                            <tbody>
                                ${results.map(r => {
                                    ...
                                    const timeGap = isDnf ? '<span style="color: var(--red); font-weight: 700;">DNF</span>' : (r?.gap === null || r?.gap === undefined ? formatRaceTime(r?.time) : formatGapLocal(r?.gap));
