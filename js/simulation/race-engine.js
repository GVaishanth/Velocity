...
window.RaceEngine = (() => {
    ...
    function initRace(track, allTeams, options = {}) {
        ...
        // === HARD RESET: clear all stale data from previous races ===
        raceState.cars.forEach(car => {
            car.lapCount = 0;
            car.trackProgress = 0;
            car.totalRaceDistance = 0;
            car.totalRaceTime = 0;
            ...
            car.bestSectorTimes = [null, null, null];
            car.currentSector = 0;
            car.position = 0;
            car.previousPosition = 0;
            car.pitStopCount = 0;
        ...
        // Sort by grid
        raceState.cars.sort((a, b) => (a.gridPosition || 99) - (b.gridPosition || 99));
        updatePositions();
    ...
    function completeLap(car) {
        if (!raceState || car.isPittingNow) return;
